...
export function renderLogin(error) {
  return `
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:var(--color-bg)">
      <form id="login-form" style="width:min(360px,90vw);border:2px solid var(--color-divider);padding:24px;display:flex;flex-direction:column;gap:12px;background:var(--color-surface)">
        <img src="assets/logo-green.png" alt="Student Digs" style="width:160px;margin:0 auto 8px">
